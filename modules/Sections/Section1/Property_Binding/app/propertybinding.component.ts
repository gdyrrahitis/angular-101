...
@Component({
    ...
    templateUrl: "modules/Sections/Section1/Property_Binding/templates/propertybinding.component.html",
    styleUrls: ["modules/Sections/Section1/Property_Binding/styles/propertybinding.style.css"]
})
