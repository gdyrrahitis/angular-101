...
@Component({
    selector: "directives",
    templateUrl: "modules/Sections/Section2/101_2.2_Services/templates/services.component.html",
    styleUrls: ["modules/Sections/Section2/101_2.2_Services/styles/services.component.css"],
